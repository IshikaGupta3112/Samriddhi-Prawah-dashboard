...
import { Dialog , DialogTitle, Box,DialogContent , DialogActions
...
<MaterialTable columns={col} data={data} 
 icons={tableIcons}
 actions={[
  {
...
options={{toolbar:false ,  headerStyle:{backgroundColor:'#109380', color:'white'}}}
